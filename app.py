...
#crete corresponding waveform graphs when button is pressed (controls for "show waves" and 3-Dim graph buttons)
@app.callback(
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            ...
            ], style={'marginTop': '1%', 'width': '20%', 'marginLeft': '200px', 'marginRight': '75px'}),
        dbc.Col([
                ...
                html.Div(id="three_dim_graph", children = [dcc.Graph(figure={}, id="three_dim")]),
                html.Center([
                    dbc.Button("Imaginary-Z", color="secondary", id="imag_z", style={'marginRight': '10px', 'marginTop': '10px'}),
                    dbc.Button("Real-Z", color="secondary", id="real_z", style={'marginRight': '10px', 'marginTop': '10px'}),
                    dbc.Button("Imaginary-Real", color="secondary", id="imag_real", style={'marginTop': '10px'}), #top view
                    html.P(id = "tester", children=[]),
                ]),
                html.Br()
                ], style = {'width': '80%', 'marginRight': '150px'})
    ]),
